...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗадачиСпринта = БИТС_ЗадачиСервер.Получить(СтрокаПодключения, Группа, Спринт);
...
Процедура ОбновитьНаСервере()
	...
	ЗадачиСпринта = БИТС_ЗадачиСервер.Получить(СтрокаПодключения, Группа, Спринт, Истина);
	СозданиеЭлементовФормы(СтадииСпринта);
	ЗаполнитьТаблицы(СтадииСпринта, ЗадачиСпринта);
...
Функция ВремяЗаСпринтНаСервере()
	...
	Результат = БИТС_ЗадачиСервер.ВремяЗаСпринт(СтрокаПодключения, ВыбранныеЗадачи, ДатаОкончания, ДатаНачала);
